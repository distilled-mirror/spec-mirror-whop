...
<div data-whop-demo-shell style={{ position: "relative", minHeight: "480px", transition: "min-height 200ms ease" }}>
  ...
  <div data-whop-demo-native="playground:payments" data-whop-elements-version="1.0.0" style={{ position: "relative" }} />
</div>
...
<CardGroup cols={2}>
  <Card title="PaymentRequest" href="/elements/latest/payments/paymentRequest">
...
<CardGroup cols={2}>
  <Card title="AddressElement" href="/elements/latest/payments/address">
  ...
  <Card title="EmailElement" href="/elements/latest/payments/email">
  ...
  <Card title="TaxIdElement" href="/elements/latest/payments/taxId">
  ...
  <Card title="BrandingElement" href="/elements/latest/payments/branding">
...
<CardGroup cols={2}>
  <Card title="PaymentElement" href="/elements/latest/payments/payment">
  ...
  <Card title="CardElement" href="/elements/latest/payments/card">
  ...
  <Card title="CardFields" href="/elements/latest/payments/cardFields">
