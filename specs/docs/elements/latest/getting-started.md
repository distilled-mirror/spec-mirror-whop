...
<div data-whop-platform="web">
  ...
  <ResponseField name="appearance" type="Appearance">
    Visual customization for every element — `theme` (light/dark + palettes), `variables` (CSS custom properties), and `classes` (per-part style declarations). The color scheme is applied before an element's first paint, so dark pages never flash light. See [Appearance](/elements/latest/appearance).
  </ResponseField>
  ...
  <CardGroup cols={2}>
    <Card title="Payments" href="/elements/latest/payments/overview">
    ...
    <Card title="Verifications" href="/elements/latest/verifications/overview">
      Collects and verifies identity information for an account.
    </Card>

    <Card title="Checkout" href="/elements/latest/checkout/overview">
    ...
    <Card title="Ads" href="/elements/latest/ads/overview">
      An advertising account.
    </Card>

    <Card title="Tracking" href="/elements/latest/tracking/overview">
      An account's tracked audience: everyone its pixel has seen, and every event they performed.
    </Card>

    <Card title="Wallet" href="/elements/latest/wallet/overview">
      Drives an account's money surfaces.
    </Card>

    <Card title="Websites" href="/elements/latest/websites/overview">
    ...
    <Card title="Dashboard" href="/elements/latest/dashboard/overview">
  ...
  * [Appearance](/elements/latest/appearance): theming, CSS variables, and per-part restyling
...
<div data-whop-platform="swift" style={{ display: "none" }}>
  ...
  * [`BalanceElement`](/elements/latest/wallet/balances-balance#swift): the total balance, its trend, and the range picker
  * [`ListElement`](/elements/latest/wallet/balances-list#swift): the holdings list
  * [`ActivityElement`](/elements/latest/wallet/activity#swift): the ledger activity feed
  ...
  * [`WhopPaymentElement`](/elements/latest/payments/payment#swift): the method tiles and whatever the selected method collects
  * [`WhopCardElement`](/elements/latest/payments/card#swift) and [`WhopCardFields`](/elements/latest/payments/cardFields#swift): the hosted card inputs, as one unit or placed one by one
  * [`WhopAddressElement`](/elements/latest/payments/address#swift): the billing address, in the country's own format
  * [`WhopEmailElement`](/elements/latest/payments/email#swift) and [`WhopTaxIDElement`](/elements/latest/payments/taxId#swift)
  * [`WhopBrandingElement`](/elements/latest/payments/branding#swift): required beside any payment surface
  * [`WhopPaymentRequest`](/elements/latest/payments/paymentRequest#swift): Apple Pay with no element mounted
...
<div data-whop-platform="react-native" style={{ display: "none" }}>
  ...
  `appearance` on `<WhopElements>` themes every element beneath it, with the same `theme` object the web elements take. See [Appearance](/elements/latest/appearance).
  ...
  * [`PaymentElement`](/elements/latest/payments/payment): the method tiles and everything the selected method needs
  * [`AddressElement`](/elements/latest/payments/address): the billing address in the buyer's own country format
  * [`CardElement`](/elements/latest/payments/card): number, expiry and security code as one component
  * [`CardFields`](/elements/latest/payments/cardFields): the same three fields, placed individually
