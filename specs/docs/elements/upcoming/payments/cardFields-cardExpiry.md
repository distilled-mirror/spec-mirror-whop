...
<div data-whop-platform="swift" style={{ display: "none" }}>
  Goes inside a [`WhopCardFields`](/elements/upcoming/payments/cardFields#swift) builder. The hosted expiry input.
</div>

<div data-whop-platform="react-native" style={{ display: "none" }}>
  Mounts inside [`CardFields`](/elements/upcoming/payments/cardFields). The expiry date on its own, so your layout decides where it sits.
</div>
  ...
  <div style={{ flex: "1 1 20rem", minWidth: 0 }}>
    <div data-whop-platform="web">
      <div data-whop-demo-shell style={{ position: "relative", minHeight: "320px", transition: "min-height 200ms ease" }}>
        ...
        <div data-whop-demo-native="element:card-fields/cardExpiry" data-whop-elements-version="" style={{ position: "relative" }} />
      </div>
