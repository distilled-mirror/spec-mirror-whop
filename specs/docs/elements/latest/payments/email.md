  ...
  <div style={{ flex: "1 1 20rem", minWidth: 0 }}>
    <div data-whop-platform="web">
      <div data-whop-demo-shell style={{ position: "relative", minHeight: "320px", transition: "min-height 200ms ease" }}>
        ...
        <div data-whop-demo-native="element:payments/email" data-whop-elements-version="1.1.0" style={{ position: "relative" }} />
      </div>
...
<div data-whop-platform="swift" style={{ display: "none" }}>
  ...
  * A verified sign-in unlocks the buyer's saved payment methods in [`WhopPaymentElement`](/elements/latest/payments/payment#swift). Read `payments.buyer` for who they are, and `payments.signOut()` to forget them.
