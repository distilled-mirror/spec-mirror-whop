...
Mounts inside [`Ads`](/elements/latest/ads/overview). Create it to get a handle, then mount its elements on that handle. Call `destroy()` to remove the sub-controller. Create it again to get a fresh handle.
...
<div data-whop-demo-shell style={{ position: "relative", minHeight: "480px", transition: "min-height 200ms ease" }}>
  ...
  <div data-whop-demo-native="unit:reporting" data-whop-elements-version="1.0.0" style={{ position: "relative" }} />
</div>
...
<CardGroup cols={2}>
  <Card title="ChartElement" href="/elements/latest/ads/reporting-chart">
  ...
  <Card title="TableElement" href="/elements/latest/ads/reporting-table">
