...
<div data-whop-platform="swift" style={{ display: "none" }}>
  Mounts inside a `WhopPayments` scope. The same three hosted inputs as [`WhopCardElement`](/elements/upcoming/payments/card#swift), placed one by one inside its content builder so your own layout decides where each sits.
</div>
...
<CardGroup cols={2}>
  <Card title="CardNumberElement" href="/elements/upcoming/payments/cardFields-cardNumber">
    PCI-isolated hosted card number field. Card numbers never reach the host page.
  </Card>

  <Card title="CardExpiryElement" href="/elements/upcoming/payments/cardFields-cardExpiry">
    PCI-isolated hosted card expiration field.
  </Card>

  <Card title="CardCvcElement" href="/elements/upcoming/payments/cardFields-cardCvc">
