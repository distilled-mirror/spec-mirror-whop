...
<Note>
  This resource has a successor in the [Current
  API](/api-reference/beta/apps/app), the versioned API that new integrations
  should build on. This page stays fully supported.
</Note>
