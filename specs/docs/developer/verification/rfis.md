...
| `company_incorrect_data`       | Account details don't match the registration document                            |
| `company_data_mismatch`        | Account details don't match Whop's records                                       |
| `company_inactive_entity`      | The account isn't listed as active in the registry                               |
...
| `company_tax_id`             | `text`   | Account tax ID in the issuing country's format                                 |
...
| `company_title`                 | `text`    | The account's name                                                                                         |
...
| Requirement                      | Type              | What to submit                                                                                                                                                |
| -------------------------------- | ----------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `business_verification_document` | `files`           | Document confirming the account's legal identity: Internal Revenue Service (IRS) Letter 147C, SS-4, or Employer Identification Number (EIN) Assistance Letter |
...
| `company_documents` | `files` | Account or entity documents                      |
