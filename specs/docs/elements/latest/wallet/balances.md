...
<div data-whop-platform="web">
  Mounts inside [`Wallet`](/elements/latest/wallet/overview). Create it to get a handle, then mount its elements on that handle. Call `destroy()` to remove the sub-controller. Create it again to get a fresh handle.
  ...
  <div data-whop-demo-shell style={{ position: "relative", minHeight: "480px", transition: "min-height 200ms ease" }}>
    ...
    <div data-whop-demo-native="unit:balances" data-whop-elements-version="1.1.0" style={{ position: "relative" }} />
  </div>
</div>

<div data-whop-platform="swift" style={{ display: "none" }}>
  Mounts anywhere in your view hierarchy. [`BalanceElement`](/elements/latest/wallet/balances-balance#swift) and [`ListElement`](/elements/latest/wallet/balances-list#swift) are independent, so use one alone or both on one screen. Each takes an `accountId` and loads its own data.
...
<div data-whop-platform="swift" style={{ display: "none" }}>
  ...
  * Read the detail on [`BalanceElement`](/elements/latest/wallet/balances-balance#swift) and [`ListElement`](/elements/latest/wallet/balances-list#swift); [`ActivityElement`](/elements/latest/wallet/activity#swift) lists the movements behind them.
...
<CardGroup cols={2}>
  <Card title="BalanceElement" href="/elements/latest/wallet/balances-balance">
  ...
  <Card title="BreakdownElement" href="/elements/latest/wallet/balances-breakdown">
  ...
  <Card title="SettlementElement" href="/elements/latest/wallet/balances-settlement">
  ...
  <Card title="ListElement" href="/elements/latest/wallet/balances-list">
