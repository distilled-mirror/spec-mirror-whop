...
<div data-whop-platform="swift" style={{ display: "none" }}>
  Goes inside a [`WhopCardFields`](/elements/latest/payments/cardFields#swift) builder. The hosted security-code input.
</div>

<div data-whop-platform="react-native" style={{ display: "none" }}>
  Mounts inside [`CardFields`](/elements/latest/payments/cardFields). The security code on its own, so your layout decides where it sits.
</div>
  ...
  <div style={{ flex: "1 1 20rem", minWidth: 0 }}>
    <div data-whop-platform="web">
      <div data-whop-demo-shell style={{ position: "relative", minHeight: "320px", transition: "min-height 200ms ease" }}>
        ...
        <div data-whop-demo-native="element:card-fields/cardCvc" data-whop-elements-version="1.1.0" style={{ position: "relative" }} />
      </div>
...
<div data-whop-platform="swift" style={{ display: "none" }}>
  ...
  Renders immediately. The expected length follows the brand the number identified, so an Amex card wants four digits and everything else three.
