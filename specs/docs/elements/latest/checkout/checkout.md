...
| `.whop-CheckoutContinue`                | The blocked-navigation press — finishes the trip the embedding page refused: the seller’s returnUrl on the completed face, the payment’s off-site step on the finish-payment face |
