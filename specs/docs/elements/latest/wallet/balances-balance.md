...
<div data-whop-platform="web">
  Mounts inside [`Balances`](/elements/latest/wallet/balances), in [`Wallet`](/elements/latest/wallet/overview). `accountId` and `currency` come from `Wallet`. Pass props and callbacks through the create options or React props.
</div>
  ...
  <div style={{ flex: "1 1 20rem", minWidth: 0 }}>
    <div data-whop-platform="web">
      <div data-whop-demo-shell style={{ position: "relative", minHeight: "320px", transition: "min-height 200ms ease" }}>
        ...
        <div data-whop-demo-native="element:balances/balance" data-whop-elements-version="1.1.0" style={{ position: "relative" }} />
      </div>
...
<div data-whop-platform="swift" style={{ display: "none" }}>
  ...
  * Pairs with [`ListElement`](/elements/latest/wallet/balances-list#swift), which breaks the same total into individual holdings.
