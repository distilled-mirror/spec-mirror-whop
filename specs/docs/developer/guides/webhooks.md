...
## Recover a subscription payment

When the bank asks the buyer to verify an off-session charge, Whop emits `payment.requires_action`. Send its `data.recovery_url` to the buyer so they can sign in to Whop and complete 3D Secure for that payment. On-session checkouts never emit it, because the buyer is already completing the challenge. A failed subscription renewal also emits `payment.failed`. Inspect `data.decline_code` and `data.failure_message` for the reason when available, and use `data.recovery_url` there too when it's present.

The same `recovery_url` field is available when you retrieve the [Payment resource](/api-reference/payments/payment). Payment lists don't include recovery links. It's `null` when authentication recovery is unavailable or you lack `member:basic:read`. Opening the link doesn't start a charge: the buyer must confirm, and Whop checks whether the payment can still be recovered. After recovery, continue handling `payment.succeeded` or `payment.failed` for the outcome.
...
| Resource                   | Events                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
| -------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| Accounts                   | [`account.financing_approved`](/api-reference/beta/accounts/account-financing-approved), [`account.financing_denied`](/api-reference/beta/accounts/account-financing-denied), [`account.updated`](/api-reference/beta/accounts/account-updated)                                                                                                                                                                                                                                                                                                                                |
| Ad Campaigns               | [`ad_campaign.payment_failed`](/api-reference/beta/ad-campaigns/ad-campaign-payment-failed), [`ad_campaign.updated`](/api-reference/beta/ad-campaigns/ad-campaign-updated)                                                                                                                                                                                                                                                                                                                                                                                                     |
| Ads                        | [`ad.updated`](/api-reference/beta/ads/ad-updated)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
...
| Ledgers                    | [`financial_activity.funds_available`](/api-reference/beta/ledgers/financial-activity-funds-available)                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
| Members                    | [`member.created`](/api-reference/beta/members/member-created), [`member.updated`](/api-reference/beta/members/member-updated)                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
...
| Payments                   | [`payment.authorized`](/api-reference/beta/payments/payment-authorized), [`payment.canceled`](/api-reference/beta/payments/payment-canceled), [`payment.created`](/api-reference/beta/payments/payment-created), [`payment.failed`](/api-reference/beta/payments/payment-failed), [`payment.pending`](/api-reference/beta/payments/payment-pending), [`payment.requires_action`](/api-reference/beta/payments/payment-requires-action), [`payment.succeeded`](/api-reference/beta/payments/payment-succeeded)                                                                  |
...
| Setup intents              | [`setup_intent.canceled`](/api-reference/beta/setup-intents/setupintent-canceled), [`setup_intent.requires_action`](/api-reference/beta/setup-intents/setupintent-requires-action), [`setup_intent.succeeded`](/api-reference/beta/setup-intents/setupintent-succeeded)                                                                                                                                                                                                                                                                                                        |
...
<CardGroup cols={2}>
  ...
  <Card title="Quickstart" href="/developer/quickstart">
