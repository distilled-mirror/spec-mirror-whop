...
<Note>Crypto deposits require a \$10 minimum.</Note>


## OpenAPI

````yaml openapi/api-v1-native.json POST /deposits
openapi: 3.1.0
info:
  description: >-
          ...
          application/json:
            schema:
              properties:
                amount:
                  description: >-
                    Amount to prefill on hosted deposit page. Crypto deposits
                    require a $10 minimum.
                  example: 50
                  type: number
                destination:
                  description: >-
                    Account ID to fund, `biz_` or `user_`. Any business resolves
                    without authentication; a user account resolves only for
          ...
          content:
            application/json:
              schema:
                properties:
                  account_id:
                    description: Account ID of the destination owner.
                    example: biz_xxxxxxxxxxxxxx
                    type:
                      - string
                      - 'null'
                    ...
                    properties:
                            ...
                            items:
                              properties:
                                ...
                                deposit_bank_address:
                                  ...
                                  example: >-
                                    2115 Linwood Avenue, Fort Lee, New Jersey
                                    07024
                                  type:
                                    - string
                                    - 'null'
                                ...
                                swift_bic:
                                  description: >-
                                    SWIFT/BIC code for international wires, when
                                    available.
                                  example: CRBAUS33
                                  type:
                                    - string
                      ...
                      crypto:
                        description: >-
                          ...
                          on that network. Crypto deposits require a $10
                          minimum.
                        items:
                          properties:
                            deposit_address:
