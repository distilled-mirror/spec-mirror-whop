...
<div data-whop-demo-shell style={{ position: "relative", minHeight: "480px", transition: "min-height 200ms ease" }}>
  ...
  <div data-whop-demo-native="playground:verifications" data-whop-elements-version="1.1.0" style={{ position: "relative" }} />
</div>
...
<CardGroup cols={2}>
  <Card title="KycElement" href="/elements/latest/verifications/kyc">
  ...
  <Card title="CapabilitiesElement" href="/elements/latest/verifications/capabilities">
  ...
  <Card title="RfiElement" href="/elements/latest/verifications/rfi">
