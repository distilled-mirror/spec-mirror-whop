...
<div data-whop-platform="swift" style={{ display: "none" }}>
  Goes inside a [`WhopCardFields`](/elements/beta/payments/cardFields#swift) builder. The hosted security-code input.
</div>
  ...
  <div style={{ flex: "1 1 20rem", minWidth: 0 }}>
    <div data-whop-platform="web">
      <div data-whop-demo-shell style={{ position: "relative", minHeight: "320px", transition: "min-height 200ms ease" }}>
        ...
        <div data-whop-demo-native="element:card-fields/cardCvc" data-whop-elements-version="1.0.0-beta.5" style={{ position: "relative" }} />
      </div>
