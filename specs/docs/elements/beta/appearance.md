...
<div data-whop-platform="react-native" style={{ display: "none" }}>
  ...
  Reading the theme yourself: `useTheme()` returns the resolved scales and tokens, which is how you match your own surrounding UI to the elements. See [Getting started](/elements/beta/getting-started).
</div>
