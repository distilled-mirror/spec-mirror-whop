...
The Current API is how you move money programmatically. Accept payments with checkout links, hold balances, send payouts, issue cards, transfer funds between accounts, and manage the products and plans you sell. Do it all from your server with one API key.
...
This reference covers the Current API. These resources are documented in the [Legacy API reference](/api-reference/payments/payment):
...
Use the API selector at the top of the sidebar to switch between references.
...
Accept payments from buyers and handle what comes after.
...
| [Setup Intents](/api-reference/beta/setup-intents/setup-intent)                                     | Saving a buyer's payment method without charging it.                       |
| [Payment Rules](/api-reference/beta/payment-rules/payment-rule)                                     | Rules an account writes to decide its own payments.                        |
