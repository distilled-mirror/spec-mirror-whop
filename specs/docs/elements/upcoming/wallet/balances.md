...
<div data-whop-platform="swift" style={{ display: "none" }}>
  Mounts anywhere in your view hierarchy. [`BalanceElement`](/elements/upcoming/wallet/balances-balance#swift) and [`ListElement`](/elements/upcoming/wallet/balances-list#swift) are independent, so use one alone or both on one screen. Each takes an `accountId` and loads its own data.
...
<div data-whop-platform="swift" style={{ display: "none" }}>
  ...
  * Read the detail on [`BalanceElement`](/elements/upcoming/wallet/balances-balance#swift) and [`ListElement`](/elements/upcoming/wallet/balances-list#swift); [`ActivityElement`](/elements/upcoming/wallet/activity#swift) lists the movements behind them.
...
<CardGroup cols={2}>
  ...
  <Card title="BreakdownElement" href="/elements/upcoming/wallet/balances-breakdown">
  ...
  <Card title="SettlementElement" href="/elements/upcoming/wallet/balances-settlement">
