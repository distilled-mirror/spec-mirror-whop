...
<div data-whop-demo-shell style={{ position: "relative", minHeight: "480px", transition: "min-height 200ms ease" }}>
  ...
  <div data-whop-demo-native="unit:reports" data-whop-elements-version="1.1.0" style={{ position: "relative" }} />
</div>
...
<CardGroup cols={2}>
  <Card title="BalanceReportElement" href="/elements/latest/wallet/reports-balanceReport">
  ...
  <Card title="ReportActivityElement" href="/elements/latest/wallet/reports-reportActivity">
